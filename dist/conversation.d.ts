import { RichContent, WhatsAppAttachmentURL, WhatsAppMessageContext, WhatsAppMessageStatus, WhatsAppPhoneNumber } from './Whatsapp/whatsapp';
...
export declare enum ConversationStatusCase {
    open = "open",
    closed = "closed",
    standby = "standby"
}
export declare enum ConversationAnswerMode {
    bot = "bot",
    manual = "manual",
    ai = "ai"
}
